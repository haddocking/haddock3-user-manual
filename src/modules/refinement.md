...
The back-mapping procedure uses the distance restraints (`*_cg_to_aa.tbl`) that were automatically generated by [`[topocg]`](https://www.bonvinlab.org/haddock3-user-manual/modules/topology.html#topocg-module) module and propagated all along the workflow. 
