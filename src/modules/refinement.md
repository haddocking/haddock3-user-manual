...
Backmapping of of Coarse-Grained (CG) models into their All-Atom (AA) counterpart.

The `[cgtoaa]` module performs the backmapping of the CG representation into AA. 
The back-mapping procedure uses the distance restraints (tables *_cg_to_aa.tbl) automatically generated by `[topocg]` module. 
