...
The restraints created define atom-to-bead restraints, with one restraint per bead set to 0Å between the bead and the geometric center of its corresponding atoms (see the [`[cgtoaa]`](https://www.bonvinlab.org/haddock3-user-manual/modules/refinement.html#cgtoaa-module) module for further details).
