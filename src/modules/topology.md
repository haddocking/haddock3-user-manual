...
2. Through an N-acetylated N-terminus to CYS bond detected using a minimum distance cutoff defined by the `acecys_dist` parameter (default 4Å). Only checked if the `cyclicpept` parameter is set to `true`
